    ...
    >
      <div className='model-height'>
          ...
          <Carousel.Slide>
            <div>
              ...
              <div className='text-center'>
                ...
                <p className='alerts-quickly'>Create alerts quickly and get notified when new car available</p>
              </div>
            </div>
        ...
        <div className="login-buttons">
          ...
          <Button className="socials-btns facebook-btn m-2 " variant="default">
            <div className='socials-btns-inner'>
              <Image width={30}
                height={30} src={facebook_icon} alt="Facebook" />
              <div>
          ...
          <Button className="socials-btns apple-btn m-2" variant="default">
            <div className='socials-btns-inner'>
              <Image width={30}
                height={30} src={apple_icon} alt="Apple" />
              <div>
                Continue with Apple
              </div>
          ...
          <Button className="socials-btns email-btn m-2" variant="default">
            <div className='socials-btns-inner'>
              <Image width={30}
                height={30} src={email_icon} alt="Email" />
              <div>
                Continue with Email
              </div>
            </div>
        ...
        <p className='text-center'>Don't have am account ? <b className='primary cursor' onClick={()=>{
          setModalOpened(true)
          socialOnClose()
        }}> Sign Up</b> </p>
      </div>
